...
const HistoryChart = ({ data }) => {
    ...
    return (
        ...
        <div className="bg-white border mt-2 rounded p-3">
            <div>{renderPrice()}</div>
            <div>
                <canvas ref={chartRef} id="myChart" width="456" height="300"></canvas>
            </div>
            ...
            <div className="chart-button mt-1">
                ...
                <button onClick={() => setTimeFormat("1m")} className="btn btn-outline-secondary btn-sm ">1m</button>
                <button onClick={() => setTimeFormat("1y")} className="btn btn-outline-secondary btn-sm mx-1">1y</button>
            </div>
        </div>
